...
-- AddForeignKey
ALTER TABLE "OpeningDetail"
ADD CONSTRAINT "OpeningDetail_IsConsistentWith_LootTable" FOREIGN KEY ("pk_pack_name", "pk_card_name") REFERENCES "LootTable" ("pk_pack_name", "pk_card_name") ON DELETE RESTRICT ON UPDATE CASCADE;
