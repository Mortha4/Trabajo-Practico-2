...
CREATE TABLE "UserData" (
    ...
    "profile_picture_path" VARCHAR(255) NOT NULL DEFAULT '/default-profile-picture.svg',
...
CREATE TABLE "CardPackType" (
    ...
    "wrapper_image_path" VARCHAR(255) NOT NULL DEFAULT '/placeholder-image.svg',
...
CREATE TABLE "CardClass" (
    ...
    "art_path" VARCHAR(255) NOT NULL DEFAULT '/placeholder-image.svg',
    "created_at" TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "modified_at" TIMESTAMPTZ,
